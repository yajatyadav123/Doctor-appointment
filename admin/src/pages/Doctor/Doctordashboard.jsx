    ...
    <div className='m-5'>
      <div className='flex flex-wrap gap-3'>
          ...
          <img className='w-14' src={assets.appointments_icon} alt="" />
            ...
            <div onClick={()=>navigate('/doctor-patients')} className='flex items-center gap-2 bg-white p-4 min-w-52 rounded border-2 border-gray-100 cursor-pointer hover:scale-105 transition-all'>
