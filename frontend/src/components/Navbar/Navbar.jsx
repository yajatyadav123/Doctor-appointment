...
const Navbar = () => {
  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
        <img onClick={()=>navigate('/')}  className='w-44 cursor-pointer' src={adminAssets.admin_logo} alt="" />
        ...
        <div className='flex items-center gap-4'>
            {
                ...
                ? <div className='flex items-center gap-2 cursor-pointer group relative'>
                    <img className='w-8 rounded-full' src={backendUrl + '/uploads/' + userData.image }alt="" />
                    <img className='w-2.5'   src={frontendAssets.dropdown_icon} alt="" />
            ...
            <img onClick={()=>setShowMenu(true)} className='w-6 md:hidden' src={frontendAssets.menu_icon} alt="" />
            {/*----------------Mobile Menu---------------------*/}
            <div className={`  ${showMenu ? 'fixed w-full' : 'h-0 w-0'}  md:hidden right-0 top-0 bottom-0 z-0 overflow-hidden bg-white transition-all `}>
                <div className='flex items-center justify-between px-5 py-6'>
                    <img className='w-36' src={frontendAssets.logo} alt="" />
                    <img className='w-7' onClick={()=>setShowMenu(false)} src={frontendAssets.cross_icon} alt="" />
                </div>
...
//useNavigate is a React Router hook used to navigate (redirect) the user to another page programmatically.